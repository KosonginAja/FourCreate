    ...
    <div class="container-xl">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="right col-md-6 justify-content-center align-items-center">
                <div class="content">
                    <h2 class="card-title crd mt-5 text-black text-center mb-3">LOGIN TO YOUR ACCOUNT</h2>
                    <p class="text text-center mb-4">Welcome back! Select method to Log In</p>
                    <p class="text-or text-center mb-1">Login With</p>
                    <form>
                        <div class="mb-2">

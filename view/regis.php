    ...
    <div class="container-xl">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="right col-md-6 justify-content-center align-items-center">
                <div class="content">
                    <h2 class="card-title crd mt-4 text-black text-center mb-1">SIGN UP NOW</h2>
                    <p class="text text-center mb-4">Already have an Account? <a href="../view/login.php">Login</a></p>
                    <form>
                        <div class="mb-1">
                            <label for="email" class="form-label">Email or Phone Number</label>
                            <input type="email or text" class="form-control form-control-lg" id="email"
                        ...
                        <button type="submit" class="btn btn-regis w-100 rounded-3 mb-2 mt-2">SIGN UP</button>
                    </form>
                    <p class="text text-center">By registering, I agree to <a href="">the terms</a> and <a
                            href="">conditions</a> and
